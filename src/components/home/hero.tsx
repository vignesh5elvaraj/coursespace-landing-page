...
>
  ...
  <Typography style = {{color : '#717171', marginTop : "20px", fontSize : "20px"}}>
  Welcome to Filibot, your digital education partner. Unleash the power of education from anywhere Just a tap away with our AI powered Filibot
  </Typography>
  </Box>
  <Box sx={{ '& button': { mr: 2 } }}>
